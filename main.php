...
<body>
    <header
        class="d-flex flex-column align-items-center flex-lg-row bg-white mx-5 mb-5 py-4 px-2 border-bottom sticky-top">
        <a href="main.php"
        ...
        <div class="d-none d-lg-block">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a href="main.php" class="nav-link active ms-3"><svg
                            xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-house" viewBox="0 0 16 16">
                            <path
                                d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z" />
                        </svg> | Home</a></li>
                <li class="nav-item"><a href="perfil.php" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <li class="px-3">
                    <form action="main.php" method="post"><input type="text" placeholder="Buscar" name="busqueda"
                            required></form>
                    <?php
