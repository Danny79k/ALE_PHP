...
<body>
    <header class="d-flex flex-wrap justify-content-center bg-white m-5 pb-2 px-2 border-bottom sticky-top">
        ...
        <ul class="nav nav-pills">
            <li class="nav-item"><a href="perfil.php?id=<?php echo $_GET['id'] ?>"
                    class="nav-link"><?php echo $registro = $select_nombre->fetch_assoc()["usuario"] ?> |</a></li>
            <li class="nav-item"><a href="main.php?id=<?php echo $_GET['id'] ?>" class="nav-link">Home</a></li>
            <li class="nav-item"><a href="perfil.php?id=<?php echo $_GET['id'] ?>" class="nav-link active">Perfil</a>
            </li>
            <li class="nav-item px-3"><button href="#" class="btn btn-outline-success" type="button"
                    data-bs-toggle="offcanvas" data-bs-target="#demo"><svg xmlns="http://www.w3.org/2000/svg" width="16"
            ...
            <div class="d-flex justify-content-center">
                <form action="insert_post.php?id=<?php echo $_GET['id'] ?>" method="post" class="shadow-lg d-inline-block p-5">
                    ...
                    <p class="bg-secondary-subtle rounded-3 p-1 mt-5 mb-5">
                        ...
                        <textarea type="text" name="contenido" class="rounded-3 border-0"></textarea>
                    </p>
                    <p class="bg-secondary-subtle rounded-3 p-1 mt-5 mb-5">
