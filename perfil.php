            ...
            <div class="fixed-top col-2">
                ...
                <div class="d-none d-lg-block">
                    <ul class="d-flex flex-column align-items-center col-12">
                        ...
                        <div class="p-3 col-12 d-flex justify-content"><a href="logout.php"
                                class="col-12 text-center text-light link-underline link-underline-opacity-0"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <div class="p-3 col-12 d-flex justify-content"><a href="compra_bot.php"
                                class="col-12 text-center text-light link-underline link-underline-opacity-0"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <section class="mt-5 d-flex flex-column col-md-10 col-12">
            <div class="d-flex flex-column align-items-center">
                ...
                <div class="d-flex flex-column mb-4 float-end col-6">
                    <a href="edit_perf_form.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <div class="border-bottom pb-2 m-5 d-flex flex-sm-row flex-column">
                            <div class="col-lg-2 col-md-2 col-12 me-5">
                                <img class="rounded-circle img-fluid "
                                    src="<?php echo (!isset($img_perf)) ? "https://t4.ftcdn.net/jpg/04/99/93/31/360_F_499933117_ZAUBfv3P1HEOsZDrnkbNCt4jc3AodArl.jpg" : $img_perf; ?>">
                            </div>
                            <p class="col-lg-12 col-md-12 col-12 d-md-block d-none">
                                <?php echo ($bio == "") ? "No hay descripcion" : $bio; ?>
                            </p>
                        </div>
                ...
                <div class="d-flex flex-column text-center col-md-7 col-10 px-3">
                    <?php
                    $consulta_display = "select * from publicaciones where id_usuario=" . $_SESSION['id'] . " order by fecha desc";
                    ...
                    if ($ejecutar_consulta->num_rows >= 1) {
                        while ($resultado = $ejecutar_consulta->fetch_assoc()) {
                            ...
                            <div class="dropdown d-md-block d-none">
                                ...
                                <ul class="dropdown-menu border-0 col-6 bg-transparent">
                                    <a href="delete_post.php?borrado=<?= $id_publicacion ?>"
                                        class="magic btn btn-danger col-3 my-1"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <a href="post_edit.php?post=<?php echo $id_publicacion ?>"
                                        class="magic btn btn-warning col-3 my-1"><svg xmlns="http://www.w3.org/2000/svg"
                                            width="16" height="16" fill="currentColor" class="bi bi-pencil-fill"
                                            viewBox="0 0 16 16">
                                            <path
                                                d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.5.5 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z" />
                                        </svg></a>
                                    <a href="post_view.php?post=<?php echo $id_publicacion ?>"
                                        class="magic btn btn-primary col-3 my-1"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="dropdown d-md-none d-block">
                                ...
                                <ul class="dropdown-menu border-0 bg-transparent">
                                    <a href="delete_post.php?borrado=<?php echo $id_publicacion ?>"
                                        class="magic btn btn-danger col-sm-3 my-1 col-12 me-4"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    ...
                                    <a href="post_edit.php?post=<?php echo $id_publicacion ?>"
                                        class="magic btn btn-warning col-sm-3 my-1 col-12 me-4" data-bs-toggle=""
                                        data-bs-target="#update"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                                            <path
                                                d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.5.5 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z" />
                                        </svg></a>
                                    <a href="post_view.php?post=<?php echo $id_publicacion ?>"
                                        class="magic btn btn-primary col-sm-3 my-1 col-12 me-4" data-bs-toggle=""
                                        data-bs-target="#update"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
