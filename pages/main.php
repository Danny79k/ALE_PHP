            ...
            <div class="fixed-top col-2">
                ...
                <div class="d-none d-lg-block">
                    <ul class="d-flex flex-column align-items-center col-12">
                        ...
                        <div class="px-3">
                            <form action="main.php" method="post"><input type="text" placeholder="Buscar"
        ...
        <section class="mt-5 d-flex flex-column col-md-10 col-12">
            <div class="d-flex flex-column align-items-center">
                <div class="d-flex flex-column text-center col-md-7 col-10 px-3">
                    <?php
                    $consulta_display = "select * from publicaciones inner join usuario on usuario.id = publicaciones.id_usuario order by fecha desc";
