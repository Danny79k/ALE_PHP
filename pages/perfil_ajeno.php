    ...
    <main class="d-flex justify-content-between">
        <aside class="col-md-2 border-end">
            <div class="fixed-top col-2">
                ...
                <div class="d-none d-lg-block">
                    <ul class="d-flex flex-column align-items-center col-12">
                        <div class="p-3 col-12 d-flex justify-content">
                            <a href="perfil_ajeno.php?id=<?= $_GET["id"] ?>"
                        ...
                        <div class="px-3">
                            <form action="perfil_ajeno.php" method="post"><input type="text" placeholder="Buscar"
                ...
                <!-- aside responsive -->
                <?php
                $select_nombre_res = $conn->query("select * from usuario where id = " . $_GET['id']);
                ?>
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="d-flex flex-column text-center col-10">
                                ...
                                <div class="border-top pt-2 mt-3">
                                    <form action="perfil_ajeno.php" method="post" class="col-12"><input class="col-12"
